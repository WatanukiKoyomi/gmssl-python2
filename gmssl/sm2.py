...
class CryptSM2(object):
    ...
    def sign(self, data, K):  # 签名函数, data消息的hash，private_key私钥，K随机数，均为16进制字符串
        ...
        E = data.encode('hex')  # 消息转化为16进制字符串
        e = int(E, 16)
    ...
    def encrypt(self, data):
        ...
        msg = data.encode("hex")  # 消息转化为16进制字符串
        ...
        if int(t, 16) == 0:
            ...
            C3 = sm3.sm3_hash([
                i for i in binascii.unhexlify('%s%s%s' % (x2, msg, y2))
            ])
    ...
    def decrypt(self, data):
        ...
        if int(t, 16) == 0:
            ...
            u = sm3.sm3_hash([
                i for i in binascii.unhexlify('%s%s%s' % (x2, M, y2))
            ])
    ...
    def _sm3_z(self, data):
        ...
        M_ = (Za + data.encode('hex')).encode('utf-8')
